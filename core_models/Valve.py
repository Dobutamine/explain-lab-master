...
class Valve:
  def __init__(self, model, **args):
    ...
    # properties
    self.name = ""            # name of the valve
    self.type = "valve"       # type of the model component
    self.subtype = "blood"    # subtype of the model component.
    self.is_enabled = True    # determines whether or not the valve is enabled
    self.no_low = False       # determines whether the valve allows any flow
    self.no_backflow = False  # determines whether the valve allows backflow
    self.comp_from = ""       # holds the name of the first compliance wich the valve connects
    self.comp_to = ""         # holds the name of the second compliance which the valve connects
    ...
    self.k1 = 0               # holds the first constant for the non-linear flow dependency of the valve
    self.k2 = 0               # holds the second constant for the non-linear flow dependency of the valve
